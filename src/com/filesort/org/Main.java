...
public class Main {
    ...
    public static void sortFiles() throws SQLException {
        ...
        Filesort sortPicturesDownload = new Filesort(MOVE_FOLDER_ONE, MOVE_FOLDER_ONE, PICTURE_FILES,
                PICTURE_EXTENSIONS);
        Filesort sortPowerpointsDownload = new Filesort(MOVE_FOLDER_ONE, MOVE_FOLDER_ONE, POWERPOINT_FILES,
        ...
        Filesort sortPowerpointsDesktop = new Filesort(MOVE_FOLDER_2, MOVE_FOLDER_2, POWERPOINT_FILES,
                POWERPOINT_EXTENSIONS);
        ...
        int totalExcelFilesMoved = sortExcelFilesDownload.calcTotalFilesMoved(excelFilesCountedDownload,
                excelFilesCountedDesktop);
        int totalPdfFilesMoved = sortPdfFilesDownload.calcTotalFilesMoved(pdfFilesCountedDownload,
                pdfFilesCountedDesktop);
        int totalPictureFilesMoved = sortPicturesDownload.calcTotalFilesMoved(pictureFilesCountedDownload,
                picturesFilesCountedDesktop);
        int totalPowerpointFilesMoved = sortPowerpointsDownload.calcTotalFilesMoved(powerpointFilesCountedDownload,
                powerpointsFilesCountedDesktop);

        sortWordFilesDesktop.checkFilesMoved(wordFilesCountedDownload, wordFilesCountedDesktop, "word",
                totalWordFilesMoved);
        sortExcelFilesDesktop.checkFilesMoved(excelFilesCountedDownload, excelFilesCountedDesktop, "excel",
                totalExcelFilesMoved);
        sortPdfFilesDesktop.checkFilesMoved(pdfFilesCountedDownload, pdfFilesCountedDesktop, "pdf", totalPdfFilesMoved);
        sortPicturesDesktop.checkFilesMoved(pictureFilesCountedDownload, picturesFilesCountedDesktop, "pictures",
                totalPictureFilesMoved);
        sortPowerpointsDesktop.checkFilesMoved(powerpointFilesCountedDownload, powerpointsFilesCountedDesktop,
                "powerpoints", totalPowerpointFilesMoved);
    }
